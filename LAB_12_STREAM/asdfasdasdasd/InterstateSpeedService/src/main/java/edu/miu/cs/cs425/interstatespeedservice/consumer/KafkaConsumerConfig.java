...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, SensorRecord> consumerFactory() {
        ...
        deserializer.setRemoveTypeHeaders(true);      // ignore the type header sent by the producer
        deserializer.setUseTypeMapperForKey(false);   // keeps keys as plain strings
